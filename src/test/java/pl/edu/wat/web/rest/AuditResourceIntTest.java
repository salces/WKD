...
import pl.edu.wat.WkdProjectApp;
import pl.edu.wat.config.audit.AuditEventConverter;
import pl.edu.wat.domain.PersistentAuditEvent;
import pl.edu.wat.repository.PersistenceAuditEventRepository;
import pl.edu.wat.service.AuditEventService;
...
@SpringBootTest(classes = WkdProjectApp.class)
